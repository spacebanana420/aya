...
public class help {
  ...
  public static String getHelp() {
    return
      ...
      + "\n"
      + "\n  * -width <pixels>        sets the screenshot's width for cropping"
      + "\n  * -height <pixels>       sets the screenshot's height for cropping"
      ...
      + "\n"
      + "\n  * -s <factor>            scales the screenshot by a factor, supports values greater than 0 (e.g. 1.25)"
      ...
      + "\n  * -tty                   enables TTY screenshot mode (Linux-only) (overrides Wayland mode)"
      + "\n"
